...
python ../python/runWinter2015SameSign.py fit Mc15SusyGG2StepWZ Rpc2L0bS
python ../python/runWinter2015SameSign.py merge Mc15SusyGG2StepWZ Rpc2L0bS
...
python ../python/runWinter2015SameSign.py fit Mc15SusyGG2StepWZ Rpc2L0bH
python ../python/runWinter2015SameSign.py merge Mc15SusyGG2StepWZ Rpc2L0bH
...
python ../python/runWinter2015SameSign.py fit Mc15SusyBtt Rpc2L1bS
python ../python/runWinter2015SameSign.py merge Mc15SusyBtt Rpc2L1bS
...
python ../python/runWinter2015SameSign.py fit Mc15SusyBtt Rpc2L1bH
python ../python/runWinter2015SameSign.py merge Mc15SusyBtt Rpc2L1bH
...
python ../python/runWinter2015SameSign.py fit doUL  Mc15SusyTT2Step Rpc3LSS1b
python ../python/runWinter2015SameSign.py merge Mc15SusyTT2Step Rpc3LSS1b

python ../python/runWinter2015SameSign.py fit Mc15SusyGG_RpvLQD Rpv2L0b
python ../python/runWinter2015SameSign.py merge Mc15SusyGG_RpvLQD Rpv2L0b
python ../python/runWinter2015SameSign.py plot Mc15SusyGG_RpvLQD Rpv2L0b

#################### Models for SROP ######################

python ../python/runWinter2015SameSign.py fit Mc15SusyGtt Rpc2L2bS
python ../python/runWinter2015SameSign.py merge Mc15SusyGtt Rpc2L2bS
...
python ../python/runWinter2015SameSign.py fit Mc15SusyGtt Rpc2L2bH
python ../python/runWinter2015SameSign.py merge Mc15SusyGtt Rpc2L2bH
...
python ../python/runWinter2015SameSign.py fit Mc15SusyGSL Rpc3L0bS
python ../python/runWinter2015SameSign.py merge Mc15SusyGSL Rpc3L0bS
...
python ../python/runWinter2015SameSign.py fit Mc15SusyGSL Rpc3L0bH
python ../python/runWinter2015SameSign.py merge Mc15SusyGSL Rpc3L0bH
...
python ../python/runWinter2015SameSign.py fit Mc15SusyGG_Rpv321 Rpv2L1bH
python ../python/runWinter2015SameSign.py merge Mc15SusyGG_Rpv321 Rpv2L1bH
python ../python/runWinter2015SameSign.py plot Mc15SusyGG_Rpv321 Rpv2L1bH

python ../python/runWinter2015SameSign.py fit Mc15SusyGG_Rpv331 Rpv2L1bH
python ../python/runWinter2015SameSign.py merge Mc15SusyGG_Rpv331 Rpv2L1bH
